...
if (file_exists(__DIR__ . '/../../../../../settings/src/resources/lang/'.basename(__DIR__).'/settings.php')) {
    return include(__DIR__ . '/../../../../../settings/src/resources/lang/'.basename(__DIR__).'/settings.php');
}
