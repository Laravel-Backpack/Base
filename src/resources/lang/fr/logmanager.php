...
if (file_exists(__DIR__ . '/../../../../../logmanager/src/resources/lang/'.basename(__DIR__).'/logmanager.php')) {
    return include(__DIR__ . '/../../../../../logmanager/src/resources/lang/'.basename(__DIR__).'/logmanager.php');
}
